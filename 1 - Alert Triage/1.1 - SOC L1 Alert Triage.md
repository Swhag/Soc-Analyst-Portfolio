...
- **Alert Name** – summary of the detected behavior 
- **Severity** – urgency level of the alert (Low → Critical)
- **Alert Status** – triage stage (New → In Progress → Resolved) 
- **Verdict** – alert classification sorting (True Positive / False Positive)
- **Assignee** – analyst currently responsible for the alert
- **Description** – detection logic and what triggered the alert
- **Alert Fields** – contextual data (hostname, user, IP, command line, file hash, etc.)
