...
## 6. Splunk Ingestion Workflow (Visual Overview)

### Splunk Home Screen
<img src="./images/splunk_home.PNG" width="700">

Splunk home view prior to starting the data ingestion process.
...
Upload method selected to ingest the VPN log dataset.
...
Local file upload used for log ingestion.
...
Splunk automatically detected the dataset structure.
...
Preview of parsed JSON events prior to indexing.
...
Default host and index settings applied for this lab environment.
...
Final review before ingesting data.
...
Initial SPL query confirming successful ingestion and searchability.
